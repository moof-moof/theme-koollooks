...
namespace eval ::tk::dialog::file {
	...
	set ::tk::Priv(updirImage) [image create photo -data {
			
	}]
    }
    if {![info exists ::tk::Priv(folderImage)]} {
	set ::tk::Priv(folderImage) [image create photo -data {
	    iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAAGHRFWHRTb2Z0d2FyZQBtYXRlLXNjcmVlbnNob3TIlvBKAAAAOElEQVQ4jWNgGAWMaPz/BOTxGvD//39U/YyMWPUz4uJgGIBVN8RQuD4mgjoIgFED0GKBTH1DHQAA+3cKD+K+OkMAAAAASUVORK5CYII=
	}]
    }
    if {![info exists ::tk::Priv(fileImage)]} {
	set ::tk::Priv(fileImage)   [image create photo -data {
	    iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAAGHRFWHRTb2Z0d2FyZQBtYXRlLXNjcmVlbnNob3TIlvBKAAAAPklEQVQ4jWNgGPKAEYvYfxLUYjfg/39UMxgZ4cow1DPhdhxWgOE6ogz4//8/A7qryHXBqAFYACkJCZ+eoQwAAmENC8S21+wAAAAASUVORK5CYII=
	}]
    }
}
